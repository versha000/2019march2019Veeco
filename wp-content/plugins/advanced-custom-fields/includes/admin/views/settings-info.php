	...
	<div class="feature-section">
		...
		<div class="acf-three-col">
			...
			<div>
				...
				<p><?php _e("ACF  contains powerful features such as repeatable data, flexible content layouts, a beautiful gallery field and the ability to create extra admin options pages!", 'acf'); ?></p>
				<p><?php printf(__('Read more about <a href="%s">ACF  features</a>.', 'acf'), esc_url('https://www.advancedcustomfields.com/pro')); ?></p>
			</div>
			
			<div>
				<h3><?php _e("Easy Upgrading", 'acf'); ?></h3>
				<p><?php _e('Upgrading to ACF  is easy. Simply purchase a license online and download the plugin!', 'acf'); ?></p>
