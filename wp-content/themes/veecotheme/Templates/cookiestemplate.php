...
<div class="sea-banner-bottom bg-white align-items-center d-flex">
    <div class="container">
        <div class="d-flex">
            <div class="bd-highlight border-right"><a href="#why">Why</a></div>
            <div class="bd-highlight border-right"><a href="#how">How</a></div>
            <div class="bd-highlight border-right"><a href="#what">What</a></div>
            <div class="bd-highlight border-right"><a href="#who">Who</a></div>
            <div class="bd-highlight "><a href="#withwhom">With whom</a></div>
        </div>
    </div>
</div>
...
<div class="bg-white align-items-center d-flex how-content">
    <div class="container">
        <div class="d-flex flex-column py-3">
            <div id="how" class="bd-highlight">
...
<div class="dark-blue align-items-center d-flex what-content">
    <div class="container">
        <div class="d-flex flex-column py-4">
            <div id="what" class="bd-highlight">
...
<div class="bg-white align-items-center d-flex how-content">
    <div class="container">
        <div class="d-flex flex-column py-4">
            <div id="withwhom" class="bd-highlight">
