					  ...
					  <div class="container-fluid">
						 <div class="row align-items-center">
								<div class="col-12 col-sm-6 left-content">
								   ...
								   <a href="<?php  echo $slde['read_link']; ?>" class="text-white"><?php echo $slde['read_text']; ?> <img class="img-fluid white-arrow" src="<?php  echo $slde['arrow_image']; ?> " alt="" /></a>
								</div>
       ...
       <div class="section">
         ...
         <div class="container-fluid">
            <div class="row flex-column-reverse flex-md-row">
                     ...
                     <section class="intro carousel slide h-auto" id="carouselExampleCaptions">
						...
						?>
                           <div class="carousel-item <?php  if($i==0) { echo 'active'; } ?> ></div>">
                            ...
                            <a href="<?php the_permalink($e_id); ?>">  <div class="section-orange">
                                <h2 class="d-flex justify-content-center text-center text-white mb-2 "><?php echo $day; ?><span class="date text-white"><?php echo $month; ?></br><?php echo $year; ?></span></h2>
                        ...
                        <a class="carousel-control-prev" href="#carouselExampleCaptions" role="button" data-slide="prev">
                           <!--span class="carousel-control-prev-icon" aria-hidden="true"></span-->
                           <img class="img-fluid"src="<?php  bloginfo('template_directory'); ?>/img/icon-1.png" alt="" />
                           <span class="sr-only">Previous</span>
                        </a>
                        <a class="carousel-control-next" href="#carouselExampleCaptions" role="button" data-slide="next">
                           <!--span class="carousel-control-next-icon" aria-hidden="true"></span-->
                           <img class="img-fluid"src="<?php  bloginfo('template_directory'); ?>/img/icon-2.png" alt="" />
                           <span class="sr-only">Next</span>
                        </a>
                     </section>
                  </div>
                  <div style="font-weight:700;" class="ml-auto arrow-tab">
                     <a style="text-decoration:none;" href="<?php  echo $philtechhomelnk; ?>" class="text-white"><?php  echo $philtechhomeimglnktxt; ?> <img class="img-fluid white-arrow" src="<?php  echo $philtechhomelnkimg; ?>" alt="" /></a>
                  </div>
               </div>
               ...
               <div class="col-md-6 bg-<?php if($i==0){ echo 'green'; } elseif($i==1){ echo 'blue'; }  else { echo 'red'; } ?> content-box flex-column">
                  <div class="left-border m-auto">
                     <p class="text-white "><?php echo $philtechtxt; ?> </p>
                  </div>
                  <div class="ml-auto arrow-tab">
                     <a href="<?php  echo $philtechhomelnk; ?>" class="text-white"><?php  echo $philtechhomeimglnktxt; ?> <img class="img-fluid white-arrow" src="<?php  echo $philtechhomelnkimg; ?>" alt="" /></a>
                  </div>
               </div>
          ...
          <div class="<?php if($i==0){ echo 'green'; } elseif($i==1){ echo 'blue'; }  else { echo 'event-box-text'; } ?> col-md-6 white-bg d-flex align-items-center content-box col-sm-push-6 flex-column phil-box-text">
                   <a  href="<?php if($i==0){ echo get_home_url().'/philtech'; } elseif($i==1) { echo get_home_url().'/solution'; } else {echo get_home_url().'/events-list'; }?>">  
                  <img class="img-fluid" src="<?php  echo $philtechimgd; ?>" alt="" />
                  <h1><?php  echo $philtechtxtd; ?></h1> </a>
               </div>
